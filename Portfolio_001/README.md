...
피해 아동을 연령별로 시각화한 그래프를 통해서는 영유아(만 3세 이하)보다는 어린이(만 4세 이상 만 13세 이하) 피해 아동이 더 많고 청소년 피해 아동의 수는 다시 감소하는 것을 확인할 수 있으나, 청소년 피해 아동 또한 많은 것을 확인할 수 있다. 그리고 이런 피해 야동의 대부분은 친부모로부터 학대를 받는다는 것을 확인할 수 있다.
